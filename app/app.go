...
func (app *StreamPayApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *StreamPayApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *StreamPayApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
