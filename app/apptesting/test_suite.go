...
func (s *KeeperTestHelper) Setup() {
	...
	s.Ctx = s.App.BaseApp.NewContextLegacy(false, tmtypes.Header{Height: 1, ChainID: ChainID, Time: time.Now().UTC()})
...
func (s *KeeperTestHelper) SetupValidator(bondStatus stakingtypes.BondStatus) sdk.ValAddress {
	...
	bondDenomResp, err := s.App.StakingKeeper.GetParams(s.Ctx)
	if err != nil {
		return nil
	}
