...
func AddBech32ConvertCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Convert any bech32 string to the streampay prefix",
		Long: `Convert any bech32 string to the streampay prefix

Example:
	streampayd debug bech32-convert juno1a6zlyvpnksx8wr6wz8wemur2xe8zyh0yst53ep

	streampayd debug bech32-convert cosmos1673f0t8p893rqyqe420mgwwz92ac4qv6n0nsjx --prefix streampay
	`,
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "streampay", "Bech32 Prefix to encode to")
